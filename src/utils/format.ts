...
const PHRASE_LABELS: Record<string, string> = {
  ...
  "Security Profiles": "Bảo mật showroom",
  ...
  "Showroom Security": "Bảo mật showroom",
  "SHOWROOM LOCK": "KHÓA SHOWROOM",
  "SHOWROOM ACCESS": "TRUY CẬP SHOWROOM",
  "Showroom Session & Access Security": "Phiên showroom & bảo mật truy cập",
  "SESSION TOKEN": "TOKEN PHIÊN",
  "REVOKE SHOWROOM SESSION": "HỦY PHIÊN SHOWROOM",
  "ACCESS VAULT": "KHO TRUY CẬP",
  ...
  "No Profiles": "Chưa có khóa bảo mật",
  "Create a profile to enable lock features for your showrooms.": "Tạo một khóa truy cập để bật tính năng khóa cho showroom.",
  ...
  "Connect profile to pull invoice pipeline.": "Kết nối truy cập showroom để tải luồng hóa đơn.",
  ...
  "SHOWROOM COMMAND CENTER // SYSTEM ONLINE": "TRUNG TÂM ĐIỀU KHIỂN SHOWROOM // HỆ THỐNG TRỰC TUYẾN",
  "FUNDS TELEMETRY": "THÔNG TIN TIỀN MẶT",
  "SHOWROOM REPUTATION": "UY TÍN SHOWROOM",
  "ESTIMATED PENDING REV": "DOANH THU DỰ KIẾN",
  "ACTIVE RMA CLAIMS": "ĐƠN BẢO HÀNH ĐANG MỞ",
  "FACILITY PROGRESSION LOG": "NHẬT KÝ TIẾN TRÌNH CƠ SỞ",
  "OPERATIONS LEVEL": "CẤP ĐỘ VẬN HÀNH",
  "ACCUMULATED XP": "KINH NGHIỆM TÍCH LŨY",
  "ACQUIRED UPGRADES": "NÂNG CẤP ĐÃ MUA",
  "INVENTORY CAPACITY": "SỨC CHỨA KHO HÀNG",
  "RECOMMENDED FACILITY DEPLOYMENT": "ĐỀ XUẤT NÂNG CẤP CƠ SỞ",
  "SHOWROOM FLOORS MONITOR // TELEMETRY LINKED": "GIÁM SÁT MẶT BẰNG SHOWROOM // TELEMETRY ĐÃ KẾT NỐI",
  "ACTIVE OPERATIONS LOG": "NHẬT KÝ HOẠT ĐỘNG HIỆN TẠI",
  "UNTESTED STOCK": "HÀNG KHO CHƯA TEST",
  "ACTIVE ORDERS": "ĐƠN HÀNG HOẠT ĐỘNG",
  "BUILD QUEUE": "HÀNG CHỜ LẮP RÁP",
  "TEST BENCH": "BÀN THỬ NGHIỆM",
  "QUOTES PROPOSED": "BÁO GIÁ ĐÃ ĐỀ XUẤT",
  "RESERVED STOCK": "HÀNG ĐÃ ĐẶT TRƯỚC",
  "DIAGNOSING CLAIMS": "YÊU CẦU ĐANG CHẨN ĐOÁN",
  "WARRANTY EXPOSURE": "RỦI RO BẢO HÀNH",
  "PERSONNEL ROSTER": "DANH SÁCH NHÂN SỰ",
  "TOTAL HEADCOUNT": "TỔNG NHÂN SỰ",
  "STANDBY / ACTIVE": "CHỜ / ĐANG LÀM",
  "DAILY DEBIT": "CHI PHÍ PHÁT SINH HÀNG NGÀY",
  "TEAM MORALE": "TÂM TRẠNG ĐỘI NGŨ",
  "MARKET LOG": "NHẬT KÝ THỊ TRƯỜNG",
  "ACTIVE PRESSURES": "BIẾN ĐỘNG HOẠT ĐỘNG",
  "PEAK COEFFICIENT": "HỆ SỐ ĐỈNH ĐIỂM",
  "PENDING SALES QUOTES": "BÁO GIÁ CHỜ XỬ LÝ",
  "ACTIVE ASSEMBLY QUEUE": "HÀNG CHỜ LẮP RÁP HOẠT ĐỘNG",
  "WARRANTY RMA INCIDENTS": "SỰ CỐ BẢO HÀNH RMA",
  "STATION_04 // SHOWROOM FRONT COUNTER": "TRẠM 04 // QUẦY TIỀN SẢNH SHOWROOM",
  "Walk-in Requests Registry": "Sổ Đăng Ký Yêu Cầu Khách Vãng Lai",
  "GENERATE WALK-IN SAMPLE": "TẠO KHÁCH VÃNG LAI MẪU",
  "ACQUISITION VERB // USE CASE": "MỤC ĐÍCH MUA // NHU CẦU SỬ DỤNG",
  "TARGET BUDGET": "NGÂN SÁCH MỤC TIÊU",
  "WAR ROOM DIAGNOSTICS": "ĐÁNH GIÁ CHẨN ĐOÁN",
  "USED_PARTS_OK": "CHẤP NHẬN ĐỒ CŨ",
  "NEW_PARTS_ONLY": "CHỈ DÙNG ĐỒ MỚI",
  "SCOUT QUOTE": "LẬP BÁO GIÁ",
  "OPEN CHAT DESK": "MỞ KHUNG CHAT",
  "RE-SCORE FIT": "TÍNH LẠI ĐỘ PHÙ HỢP",
  "CORE OPTIONS // SAVE DIAGNOSTICS": "TÙY CHỌN CỐT LÕI // CHẨN ĐOÁN BẢN LƯU",
  "SAVE STATE": "TRẠNG THÁI LƯU",
  "PROFILE LOCK": "KHÓA SHOWROOM",
  "BACKEND HEALTH": "TRẠNG THÁI BACKEND",
  "Active Save Game Configuration": "Cấu hình bản lưu đang hoạt động",
  "SHOWROOM NAME": "TÊN SHOWROOM",
  "SAVE DIRECTORY INDEX": "MÃ CHỈ MỤC BẢN LƯU",
  "CURRENT CYCLE": "CHU KỲ HIỆN TẠI",
  "REPUTATION LEVEL": "MỨC ĐỘ UY TÍN",
  "SAVE NOW": "LƯU NGAY",
  "EXPORT METADATA": "XUẤT METADATA",
  "PIN Lock & Access Security": "Khóa PIN & Bảo mật Truy cập",
  "ASSIGNED PROFILE": "TRUY CẬP SHOWROOM",
  "PIN STATUS": "TRẠNG THÁI PIN",
  "VERIFIED SESSION TOKEN": "TOKEN PHIÊN ĐÃ XÁC THỰC",
  "REVOKE LOCK SESSION": "HỦY PHIÊN KHÓA",
  "PROFILES SETTINGS": "CÀI ĐẶT TRUY CẬP",
  "DANGEROUS OPERATIONS ZONE": "KHU VỰC THAO TÁC NGUY HIỂM",
  "RESET SYSTEMS COLD [LOCKED]": "KHỞI ĐỘNG LẠI HỆ THỐNG [ĐÃ KHÓA]",
  "Diagnostics & Connection Logs": "Chẩn đoán & Nhật ký Kết nối",
  "RUN TESTS": "CHẠY THỬ NGHIỆM",
  "LOCAL SYNC ARCHITECTURE NOTICE": "LƯU Ý CẤU TRÚC ĐỒNG BỘ CỤC BỘ",
};
